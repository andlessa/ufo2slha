...
C     
C     Process: d d~ > w+ w- WEIGHTED<=4 @3
C     Process: s s~ > w+ w- WEIGHTED<=4 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,5),W(1,4),W(1,3),GC_4,AMP(1))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,4),W(1,3),W(1,5),GC_53,AMP(2))
      CALL FFV2_2(W(1,1),W(1,4),GC_100,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_100,AMP(3))
