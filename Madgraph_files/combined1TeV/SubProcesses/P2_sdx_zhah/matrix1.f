...
C     
C     Process: s d~ > zh ah WEIGHTED<=4 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_269,AMP(4))
      CALL FFV2_2(W(1,1),W(1,4),GC_209,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_245,AMP(5))
      CALL FFV2_2(W(1,1),W(1,4),GC_212,MDL_MHS,MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_257,AMP(6))
