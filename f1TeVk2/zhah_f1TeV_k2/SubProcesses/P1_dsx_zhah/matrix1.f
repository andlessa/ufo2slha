...
C     
C     Process: d s~ > zh ah WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_273,AMP(4))
      CALL FFV2_2(W(1,1),W(1,4),GC_208,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_249,AMP(5))
      CALL FFV2_2(W(1,1),W(1,4),GC_211,MDL_MHS,MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_261,AMP(6))
