...
C     
C     Process: g u~ > wh- dh~ WEIGHTED<=3 @560
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,5),W(1,3),GC_16,AMP(1))
      CALL FFV1_2(W(1,4),W(1,1),GC_9,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_16,AMP(2))
