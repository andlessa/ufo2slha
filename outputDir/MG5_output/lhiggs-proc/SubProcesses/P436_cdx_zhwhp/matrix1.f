...
C     
C     Process: c d~ > zh wh+ WEIGHTED<=4 @436
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,5),W(1,4),W(1,3),GC_48,AMP(1))
      CALL FFV2_2(W(1,1),W(1,3),GC_196,MDL_MHC,MDL_WHC,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_255,AMP(2))
      CALL FFV2_2(W(1,1),W(1,4),GC_16,MDL_MHS,MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_257,AMP(3))
