...
C     
C     Process: c d > sh ch WEIGHTED<=4 @72
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,2),W(1,4),W(1,5),GC_21,AMP(1))
      CALL FFV2_3(W(1,1),W(1,4),GC_206,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,2),W(1,3),W(1,5),GC_211,AMP(2))
      CALL FFV2_3(W(1,1),W(1,4),GC_196,MDL_MZH,MDL_WZH,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,2),W(1,3),W(1,5),GC_200,AMP(3))
