...
C     
C     Process: s s > bh bh WEIGHTED<=4 @138
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV2_3(W(1,1),W(1,3),GC_215,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,2),W(1,4),W(1,5),GC_215,AMP(1))
      CALL FFV2_3(W(1,1),W(1,3),GC_204,MDL_MZH,MDL_WZH,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,2),W(1,4),W(1,5),GC_204,AMP(2))
      CALL FFV2_3(W(1,1),W(1,4),GC_215,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,2),W(1,3),W(1,5),GC_215,AMP(3))
      CALL FFV2_3(W(1,1),W(1,4),GC_204,MDL_MZH,MDL_WZH,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,2),W(1,3),W(1,5),GC_204,AMP(4))
