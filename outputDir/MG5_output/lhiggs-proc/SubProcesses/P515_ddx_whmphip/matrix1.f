...
C     
C     Process: d d~ > wh- phi+ WEIGHTED<=4 @515
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL VSS2_0(W(1,3),W(1,5),W(1,4),GC_142,AMP(1))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,5),W(1,3),W(1,4),GC_163,AMP(2))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_116,GC_104,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,3),W(1,5),W(1,4),GC_177,AMP(3))
