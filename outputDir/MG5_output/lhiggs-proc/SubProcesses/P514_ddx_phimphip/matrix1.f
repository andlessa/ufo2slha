...
C     
C     Process: d d~ > phi- phi+ WEIGHTED<=4 @514
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL SSS1_0(W(1,5),W(1,3),W(1,4),GC_156,AMP(1))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VSS3_0(W(1,5),W(1,3),W(1,4),GC_4,AMP(2))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_116,GC_104,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VSS3_0(W(1,5),W(1,3),W(1,4),GC_112,AMP(3))
