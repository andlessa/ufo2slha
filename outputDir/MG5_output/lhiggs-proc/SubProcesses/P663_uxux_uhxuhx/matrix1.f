...
C     
C     Process: u~ u~ > uh~ uh~ WEIGHTED<=4 @663
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL IXXXXX(P(0,3),MDL_MHU,NHEL(3),-1*IC(3),W(1,3))
      CALL IXXXXX(P(0,4),MDL_MHU,NHEL(4),-1*IC(4),W(1,4))
      CALL FFV2_3(W(1,3),W(1,1),GC_206,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,2),W(1,5),GC_206,AMP(1))
      CALL FFV2_3(W(1,3),W(1,1),GC_196,MDL_MZH,MDL_WZH,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,2),W(1,5),GC_196,AMP(2))
      CALL FFV2_3(W(1,4),W(1,1),GC_206,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,3),W(1,2),W(1,5),GC_206,AMP(3))
      CALL FFV2_3(W(1,4),W(1,1),GC_196,MDL_MZH,MDL_WZH,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,3),W(1,2),W(1,5),GC_196,AMP(4))
