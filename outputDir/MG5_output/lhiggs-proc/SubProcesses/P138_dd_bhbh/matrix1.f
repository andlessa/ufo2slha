...
C     
C     Process: d d > bh bh WEIGHTED<=4 @138
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL OXXXXX(P(0,3),MDL_MHB,NHEL(3),+1*IC(3),W(1,3))
      CALL OXXXXX(P(0,4),MDL_MHB,NHEL(4),+1*IC(4),W(1,4))
      CALL FFV2_3(W(1,1),W(1,3),GC_214,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,2),W(1,4),W(1,5),GC_214,AMP(1))
      CALL FFV2_3(W(1,1),W(1,3),GC_203,MDL_MZH,MDL_WZH,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,2),W(1,4),W(1,5),GC_203,AMP(2))
      CALL FFV2_3(W(1,1),W(1,4),GC_214,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,2),W(1,3),W(1,5),GC_214,AMP(3))
      CALL FFV2_3(W(1,1),W(1,4),GC_203,MDL_MZH,MDL_WZH,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,2),W(1,3),W(1,5),GC_203,AMP(4))
