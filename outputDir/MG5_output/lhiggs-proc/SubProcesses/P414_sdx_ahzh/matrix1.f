...
C     
C     Process: s d~ > ah zh WEIGHTED<=4 @414
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_269,AMP(1))
      CALL FFV2_2(W(1,1),W(1,3),GC_209,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_245,AMP(2))
      CALL FFV2_2(W(1,1),W(1,3),GC_212,MDL_MHS,MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_257,AMP(3))
