...
C     
C     Process: c c~ > tah+ tah- WEIGHTED<=4 @377
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL IXXXXX(P(0,3),MDL_MHTA,NHEL(3),-1*IC(3),W(1,3))
      CALL OXXXXX(P(0,4),MDL_MHTA,NHEL(4),+1*IC(4),W(1,4))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_117,GC_105,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,3),W(1,4),W(1,5),GC_133,AMP(1))
