...
C     
C     Process: g g > theven~ theven WEIGHTED<=2 @252
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL IXXXXX(P(0,3),MDL_MHTEVEN,NHEL(3),-1*IC(3),W(1,3))
      CALL OXXXXX(P(0,4),MDL_MHTEVEN,NHEL(4),+1*IC(4),W(1,4))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_8,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,3),W(1,4),W(1,5),GC_9,AMP(1))
      CALL FFV1_2(W(1,3),W(1,1),GC_9,MDL_MHTEVEN,MDL_WHTEVEN,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,5),W(1,4),W(1,2),GC_9,AMP(2))
      CALL FFV1_1(W(1,4),W(1,1),GC_9,MDL_MHTEVEN,MDL_WHTEVEN,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,3),W(1,5),W(1,2),GC_9,AMP(3))
