...
C     
C     Process: c s > sh ch WEIGHTED<=4 @72
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV2_3(W(1,1),W(1,3),GC_16,MDL_MWH,MDL_WWH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,2),W(1,4),W(1,5),GC_22,AMP(1))
      CALL FFV2_3(W(1,1),W(1,4),GC_206,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,2),W(1,3),W(1,5),GC_212,AMP(2))
      CALL FFV2_3(W(1,1),W(1,4),GC_196,MDL_MZH,MDL_WZH,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,2),W(1,3),W(1,5),GC_201,AMP(3))
