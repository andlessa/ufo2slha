...
C     
C     Process: s s~ > wh- wh+ WEIGHTED<=4 @461
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL VXXXXX(P(0,3),MDL_MWH,NHEL(3),+1*IC(3),W(1,3))
      CALL VXXXXX(P(0,4),MDL_MWH,NHEL(4),+1*IC(4),W(1,4))
      CALL FFS4_3(W(1,1),W(1,2),GC_239,MDL_MH,MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,3),W(1,4),W(1,5),GC_148,AMP(1))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,5),W(1,3),W(1,4),GC_107,AMP(2))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_116,GC_104,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,3),W(1,4),W(1,5),GC_49,AMP(3))
      CALL FFV2_2(W(1,1),W(1,3),GC_22,MDL_MHC,MDL_WHC,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_259,AMP(4))
      CALL FFV2_2(W(1,1),W(1,3),GC_25,MDL_MHT,MDL_WHT,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_271,AMP(5))
      CALL FFV2_2(W(1,1),W(1,3),GC_19,MDL_MHU,MDL_WHU,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_247,AMP(6))
