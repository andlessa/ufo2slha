...
C     
C     Process: d s~ > ah zh WEIGHTED<=4 @414
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_273,AMP(1))
      CALL FFV2_2(W(1,1),W(1,3),GC_208,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_249,AMP(2))
      CALL FFV2_2(W(1,1),W(1,3),GC_211,MDL_MHS,MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_261,AMP(3))
