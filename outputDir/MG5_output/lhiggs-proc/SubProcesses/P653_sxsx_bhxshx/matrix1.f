...
C     
C     Process: s~ s~ > bh~ sh~ WEIGHTED<=4 @653
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV2_3(W(1,3),W(1,1),GC_274,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,2),W(1,5),GC_262,AMP(1))
      CALL FFV2_3(W(1,3),W(1,1),GC_273,MDL_MZH,MDL_WZH,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,2),W(1,5),GC_261,AMP(2))
      CALL FFV2_3(W(1,4),W(1,1),GC_262,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,3),W(1,2),W(1,5),GC_274,AMP(3))
      CALL FFV2_3(W(1,4),W(1,1),GC_261,MDL_MZH,MDL_WZH,W(1,5))
