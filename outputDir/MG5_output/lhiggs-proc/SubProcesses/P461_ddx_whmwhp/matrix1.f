...
C     
C     Process: d d~ > wh- wh+ WEIGHTED<=4 @461
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_2(W(1,1),W(1,3),GC_21,MDL_MHC,MDL_WHC,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_255,AMP(4))
      CALL FFV2_2(W(1,1),W(1,3),GC_24,MDL_MHT,MDL_WHT,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_267,AMP(5))
      CALL FFV2_2(W(1,1),W(1,3),GC_18,MDL_MHU,MDL_WHU,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_243,AMP(6))
