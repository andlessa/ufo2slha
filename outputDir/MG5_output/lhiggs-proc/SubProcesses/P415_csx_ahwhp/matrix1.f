...
C     
C     Process: c s~ > ah wh+ WEIGHTED<=4 @415
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,3),W(1,5),W(1,4),GC_89,AMP(1))
      CALL FFV2_2(W(1,1),W(1,3),GC_206,MDL_MHC,MDL_WHC,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_259,AMP(2))
      CALL FFV2_2(W(1,1),W(1,4),GC_16,MDL_MHS,MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_262,AMP(3))
