...
C     
C     Process: d d~ > ah ah WEIGHTED<=4 @413
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFS4_3(W(1,1),W(1,2),GC_236,MDL_MH,MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,3),W(1,4),W(1,5),GC_141,AMP(1))
      CALL FFV2_2(W(1,1),W(1,3),GC_214,MDL_MHB,MDL_WHB,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_270,AMP(2))
      CALL FFV2_2(W(1,1),W(1,3),GC_208,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_246,AMP(3))
      CALL FFV2_2(W(1,1),W(1,3),GC_211,MDL_MHS,MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_258,AMP(4))
      CALL FFV2_2(W(1,1),W(1,4),GC_214,MDL_MHB,MDL_WHB,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_270,AMP(5))
      CALL FFV2_2(W(1,1),W(1,4),GC_208,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_246,AMP(6))
      CALL FFV2_2(W(1,1),W(1,4),GC_211,MDL_MHS,MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_258,AMP(7))
