...
C     
C     Process: u s > dh uh WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,2),W(1,4),W(1,5),GC_19,AMP(1))
      CALL FFV2_3(W(1,1),W(1,4),GC_206,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,2),W(1,3),W(1,5),GC_209,AMP(2))
      CALL FFV2_3(W(1,1),W(1,4),GC_196,MDL_MZH,MDL_WZH,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,2),W(1,3),W(1,5),GC_198,AMP(3))
