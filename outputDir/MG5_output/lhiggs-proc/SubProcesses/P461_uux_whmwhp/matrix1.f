...
C     
C     Process: u u~ > wh- wh+ WEIGHTED<=4 @461
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFS4_3(W(1,1),W(1,2),GC_242,MDL_MH,MDL_WH,W(1,5))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3_3(W(1,1),W(1,2),GC_117,GC_105,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,3),W(1,4),W(1,5),GC_49,AMP(3))
      CALL FFV2_2(W(1,1),W(1,4),GC_16,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_16,AMP(4))
