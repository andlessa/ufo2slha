...
C     
C     Process: c s~ > sh~ ch WEIGHTED<=4 @135
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_260,MDL_MW,MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_3_0(W(1,3),W(1,4),W(1,5),GC_16,GC_181,AMP(1))
      CALL FFV2_3(W(1,1),W(1,4),GC_206,MDL_MAH,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,3),W(1,2),W(1,5),GC_262,AMP(2))
      CALL FFV2_3(W(1,1),W(1,4),GC_196,MDL_MZH,MDL_WZH,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,3),W(1,2),W(1,5),GC_261,AMP(3))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+AMP(1)
      JAMP(2,1)=-AMP(2)-AMP(3)
