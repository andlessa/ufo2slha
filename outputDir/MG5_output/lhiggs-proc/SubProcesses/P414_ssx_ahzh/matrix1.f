...
C     
C     Process: s s~ > ah zh WEIGHTED<=4 @414
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_273,AMP(2))
      CALL FFV2_2(W(1,1),W(1,3),GC_209,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_249,AMP(3))
      CALL FFV2_2(W(1,1),W(1,3),GC_212,MDL_MHS,MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_261,AMP(4))
      CALL FFV2_2(W(1,1),W(1,4),GC_204,MDL_MHB,MDL_WHB,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_274,AMP(5))
      CALL FFV2_2(W(1,1),W(1,4),GC_198,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_250,AMP(6))
      CALL FFV2_2(W(1,1),W(1,4),GC_201,MDL_MHS,MDL_WHS,W(1,5))
