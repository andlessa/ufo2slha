...
C     
C     Process: d d~ > ah zh WEIGHTED<=4 @414
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,3),W(1,4),W(1,5),GC_147,AMP(1))
      CALL FFV2_2(W(1,1),W(1,3),GC_214,MDL_MHB,MDL_WHB,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_269,AMP(2))
      CALL FFV2_2(W(1,1),W(1,3),GC_208,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_245,AMP(3))
      CALL FFV2_2(W(1,1),W(1,3),GC_211,MDL_MHS,MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_257,AMP(4))
      CALL FFV2_2(W(1,1),W(1,4),GC_203,MDL_MHB,MDL_WHB,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_270,AMP(5))
      CALL FFV2_2(W(1,1),W(1,4),GC_197,MDL_MHD,MDL_WHD,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_246,AMP(6))
      CALL FFV2_2(W(1,1),W(1,4),GC_200,MDL_MHS,MDL_WHS,W(1,5))
