...
C     
C     Process: g c > ch ah WEIGHTED<=3 @116
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV1_2(W(1,2),W(1,1),GC_9,MDL_MC,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,5),W(1,3),W(1,4),GC_206,AMP(1))
      CALL FFV1_1(W(1,3),W(1,1),GC_9,MDL_MHC,MDL_WHC,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,2),W(1,5),W(1,4),GC_206,AMP(2))
