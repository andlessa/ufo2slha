...
C     
C     Process: d s~ > wh- wh+ WEIGHTED<=4 @461
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_259,AMP(1))
      CALL FFV2_2(W(1,1),W(1,3),GC_24,MDL_MHT,MDL_WHT,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_271,AMP(2))
      CALL FFV2_2(W(1,1),W(1,3),GC_18,MDL_MHU,MDL_WHU,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_247,AMP(3))
