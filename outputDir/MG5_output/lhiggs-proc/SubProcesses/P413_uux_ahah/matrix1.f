...
C     
C     Process: u u~ > ah ah WEIGHTED<=4 @413
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_2(W(1,1),W(1,3),GC_206,MDL_MHU,MDL_WHU,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_206,AMP(2))
      CALL FFV2_2(W(1,1),W(1,4),GC_206,MDL_MHU,MDL_WHU,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_206,AMP(3))
